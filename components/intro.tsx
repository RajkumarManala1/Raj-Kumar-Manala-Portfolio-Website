...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hi, I'm Raj</span> I love challenging myself I am a results-oriented{" "}
        ...
        building <span className="italic">ETL pipelines & Dashboards</span>. My focus is{" "}
